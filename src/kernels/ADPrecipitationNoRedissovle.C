// This kernel include precipitation (no redissolution) USING AD

#include "ADPrecipitationNoRedissovle.h"
#include <cmath>

registerADMooseObject("PhoenixApp", ADPrecipitationNoRedissovle);

defineADValidParams(ADPrecipitationNoRedissovle,
                    ADKernel,
...
ADPrecipitationNoRedissovle<compute_stage>::ADPrecipitationNoRedissovle(const InputParameters & parameters) :
...
template <ComputeStage compute_stage>
ADResidual
ADPrecipitationNoRedissovle<compute_stage>::computeQpResidual()
{
  ADReal r = 0.0;
