#Use mole will make the simulation struggle because of the small value
...
[Kernels]
  [Insolid_fuel_Ln_Generation_l]
    ...
    type = BodyForce
    value = 1.4129e-23 # mol per second, 8.5084 my atom per second
    variable = S_dissolve
    block = 'fuel_l'
  []
...
[AuxKernels]
  ...
  [Solubility_fuel_relate_temperature]
    ...
    constant_expressions = '0.003 7.76e-14'
  ...
  [Solubility_pore_relate_temperature]
    ...
    constant_expressions = '1.34e-14 0.66739735 -4.22401343 8.61733e-5'
  ...
  [Solubility_gap_relate_temperature]
    ...
    constant_expressions = '3.50e-14 0.22056278 -15.57626517 8.61733e-5'
    function = 'density * exp (-Q_s/k/T) * exp(Ln_S0)'
    block = 'gap_r'
  []
[]
